...
<div class="row">
	<div class="span3 well">
		...
		<p>
			Im späteren Spielverlauf wird es Möglichkeiten geben, den eigenen Charakter zu verbessern und so neue Spielvarianten und Winkelzüge freizuschalten. Sei gespannt!
		</p>
	</div>
	<div class="span3 well">
		<h2>Wohnung</h2>
		...
		<p>
			<strong>Aber Achtung! </strong>Man kann einer Wohnung nicht "ansehen", ob sie noch ohne Makler ist. Solltest Du versuchen, eine bereits besetzte Wohnung zu übernehmen, erhält der Wohnungsinhaber <strong>eine Strafzahlung in Höhe einer Tagesmiete</strong> von Dir.
		</p>
	</div>
	<div class="span3 well">
		<h2>Portfolio</h2>
		...
		<p>Hier kannst Du auch <strong>Wohnungen wieder abgeben</strong>, solltest Du Deine Meinung über die Chancen der Wohnung geändert haben. Nach einer <strong>Strafzahlung in Höhe einer Tagesmiete</strong> zahlst Du in Zukunft keine Miete mehr und ein anderer Makler kann die Wohnung übernehmen.
		</p>
	</div>
</div>
<div class="row">
	<div class="span3 well">
		...
		<p>
			Wird eine Wohnung im "echten Leben" vermietet (und verschwindet damit von ImmobilienScout24) <strong>erhältst</strong> Du als Makler die <strong>zweifache Nettokaltmiete als Provision</strong>.
		</p>
	</div>
	<div class="span3 well">
		<h2>Bestenliste</h2>
		...
		<p>
			Liefer Dir spannende Rennen mit Deinen Freunden in Deinem Kiez um die besten Wohnungen und die Spitze der Topliste.
		</p>
	</div>
	<div class="span3 well">
