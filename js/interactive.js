 ...
 */ 
   ...
   * @param specifier defines a special sub-type of callType
	...
	function objectToArrayVar(callType, specifier, jsonData, intIndex){
      ...
      //coloring actions
      text = text.replace(/(Provision:.+?Eur)/,"<p class=\"btn-success btn-small\">$1</p>");
      text = text.replace(/(Belohnung:.+?Eur)/,"<p class=\"btn-success btn-small\">$1</p>");
      text = text.replace(/(Strafe:.+?Eur)/,"<p class=\"btn-danger btn-small\">$1</p>");
      text = text.replace(/(Miete:.+?Eur)/,"<p class=\"btn-danger btn-small\">$1</p>");
      text = text.replace(/(Übernahmekosten:.+?Eur)/,"<p class=\"btn-warning btn-small\">$1</p>");
